        ...
        <section id="about" className="py-16 px-4 bg-white">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div className="bg-gray-100 p-6 rounded shadow-md">
                    <h3 className="text-xl font-semibold mb-2 text-yellow-400">Reliable Urban Transportation</h3>
                    <p className="text-gray-800">We ensure you reach your destination quickly and safely.</p>
                </div>
                <div className="bg-gray-100 p-6 rounded shadow-md">
                    <h3 className="text-xl font-semibold mb-2 text-yellow-400">Exceptional Customer Service</h3>
                    <p className="text-gray-800">Our drivers are dedicated to your comfort and satisfaction.</p>
                </div>
                <div className="bg-gray-100 p-6 rounded shadow-md">
                    <h3 className="text-xl font-semibold mb-2 text-yellow-400">Convenient Booking Options</h3>
